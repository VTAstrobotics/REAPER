...
ros2 run camera_streamer usbCamStreamer --cam 1 &
ros2 run camera_streamer usbCamStreamer --cam 2 &
ros2 run camera_streamer usbCamStreamer --cam 3 &
ros2 run camera_streamer usbCamStreamer --cam 4 &
ros2 run camera_streamer usbCamStreamer --cam 5 &
